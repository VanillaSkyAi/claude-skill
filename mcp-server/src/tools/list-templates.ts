...
const TEMPLATES: Template[] = [
  ...
  },
  {
    ...
    variables: [
      ...
      { name: "segments", type: "string", required: true, default: "40,25,20,15", description: "Comma-separated percentage values summing to ~100. Each value is a slice size." },
  ...
  },
  {
    ...
    label: "Notification",
    category: "social",
    description: "iOS-style push notification sliding down over animated gradient background. Green app icon, sender name, message text.",
    ...
    usesGlobalBackgroundEffect: false,
    whenToUse: "Attention-grabbing notification moment. Great for announcing features, updates, or showing the app in action. Max 1 per video.",
    copyTip: "Keep the message short — like a real push notification. 'Your order is on its way!' / 'New feature: Dark mode'",
  },
  {
    id: "social-chat",
